...
class FrontendStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendRequest = channel.unary_unary(
                '/simulation.Frontend/SendRequest',
...
def add_FrontendServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'simulation.Frontend', rpc_method_handlers)
...
class Frontend(object):
    ...
    def SendRequest(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/simulation.Frontend/SendRequest',
